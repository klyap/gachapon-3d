  ...
  return (
    <Canvas dpr={1.5} linear camera={{ far:100000, near:5, fov:20, position:[-43.88, 218.96, 1766.62]}}>
      <Suspense fallback={null}>
        ...
        <StarKnob />
        <Floaty gltfNodeName='Icosahedron_3' material={material.gem(0xD998F6)} position={[-100, -60, -790]} rotation={[-1.38, 1.01, -0.06]} scale={[2.06, 2.79, 0.36]} />
        <Floaty gltfNodeName='Icosahedron_3_1' material={material.gem(0x77BBDA)} position={[70, -20, -890]} rotation={[0.15, 0.33, -0.61]} scale={[2.06, 2.79, 2.79]} />
        ...
        <Floaty gltfNodeName='ball_5' material={material.bubble3} position={[-30, -30, -840]} rotation={[0, 0, 0]} scale={[2.9, 2.8, 2.7]} />
