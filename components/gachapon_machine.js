...
export function GachaponMachine(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <group position={[-138.6, 333.34, 383.79]}>
      ...
      <mesh geometry={nodes.Torus_3.geometry} material={material.pink} position={[-23.98, -10.81, 509.3]} rotation={[-0.02, 0, 0]} scale={2.79} />
      <mesh geometry={nodes.ball.geometry} material={nodes.ball.material} position={[78.94, 144.08, -69.66]} rotation={[-Math.PI / 2, 0, 0]} />
