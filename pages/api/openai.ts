...
export const generateItem = async () => {
  ...
  const req = {
    ...
    "prompt": "give me a name for a quirky space quest item, followed by the symbol ' - ' and then a short description of its appearance and sarcastic fun horoscope-like prediction about your personality\n",
